...
from app.models.schemas import (
    IncomingMessage, BotResponse, PlatformConfigResponse,
    SessionStatusResponse, SessionListResponse, StatsResponse,
...
from app.api.dependencies import get_auth, verify_internal_api_key, verify_webhook_secret
...
async def get_sessions(
    platform: Optional[str] = Query(None, description="Filter by platform (telegram/internal)"),
...
async def clear_sessions(
    ...
    if platform:
        keys_to_remove = [
            key for key, session in session_manager.sessions.items()
